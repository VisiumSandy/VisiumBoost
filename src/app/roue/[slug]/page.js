  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        maxWidth: 420, width: "100%", border: "1.5px solid #E2E8F0",
      }}>
        <div style={{
          width: 72, height: 72, borderRadius: "50%", background: `${c}18`,
...
export default async function RouePage({ params }) {
  ...
  // Serialize — identical to /s/[slug]/page.js so PlayClient gets the same data
  const data = {
    ...
    // Theme — nested object, falls back to legacy flat fields in PlayClient
